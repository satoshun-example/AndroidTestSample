...
import com.github.satoshun.test.sample.R;
import com.github.satoshun.test.sample.data.user.RemoteUserRepository;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new MainPresenter(new RemoteUserRepository(), this);
    }
    ...
    public void showNoUser() {
        ((TextView) findViewById(R.id.user)).setText("Empty User");
    }
